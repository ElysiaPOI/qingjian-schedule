...
2. 点击 **Run workflow**。
3. 构建完成后下载 `qingjian-schedule-release`。
4. 解压并安装其中的 `清简课表-v*.apk`。
...
节假日数据离线保存在应用中，当前依据[国务院办公厅关于 2026 年部分节假日安排的通知](https://www.gov.cn/gongbao/2025/issue_12406/202511/content_7048922.html)。尚未正式公布的年度不预先推测，待官方通知发布后再随版本更新。
...
```bash
git clone https://github.com/ElysiaPOI/qingjian-schedule.git
cd qingjian-schedule
npm install
npm run dev
```
